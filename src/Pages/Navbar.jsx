...
//     setIsMenuOpen(false);
//     navigate("/auth"); // change if needed
//   };
...
//         className={`cursor-pointer relative overflow-hidden border px-4 py-1 rounded-full text-sm font-medium transition-all duration-300 ease-in-out
...
//         <button
//           onClick={handleLogout}
//           className="border px-6 py-2 rounded-full text-sm font-medium hover:bg-red-500 hover:text-white transition"
//         >
//           Logout
//         </button>
//       </div>
...
const Navbar = () => {
  ...
  return (
    ...
    ${isScrolled ? "text-black border-black" : "text-white border-white"}
    hover:bg-red-500 hover:text-white hover:scale-105 active:scale-95 shadow-sm hover:shadow-lg`}
        >
          <span className="relative z-10">Logout</span>
          <span className="absolute inset-0 bg-red-500 opacity-0 hover:opacity-20 transition-opacity duration-300"></span>
        </button>
